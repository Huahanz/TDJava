...
/**
 * 
 * We need to ensure that the underlying classes are thread safe. And above of
 * that, we need to make sure all the references don't have interleave. The
 * thread safety of this class is depend on Simulator.java, SwingFrame.java,
 * GameInfo.java and Executor.java
 * 
 */
public class Setup {
