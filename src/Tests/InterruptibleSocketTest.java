...
class InterruptibleSocketFrame extends JFrame
{
   ...
   public void connectInterruptibly() throws IOException
   {
      ...
      SocketChannel channel = SocketChannel.open(new InetSocketAddress("localhost/~huahan/PPServer/index.php/blog/index", 8080));
      try
      {
   ...
   public void connectBlocking() throws IOException
   {
      ...
      Socket sock = new Socket("http://localhost/~huahan/PPServer/index.php/blog/index", 8080);
      try
      {
